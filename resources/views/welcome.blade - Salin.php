        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            ...
            <ul>
              ...
              <li><i class="icofont-check-circled"></i> Calon Pendaftar melengkapi Formulir online.</li>
              <li><i class="icofont-check-circled"></i> Calon Pendaftar menunggu hasil seleksi pada tanggal 30 Juni 2021 melalui laman htttps://ppdb.bantenprov.go.id.</li>
            </ul>
        ...
        <div class="table-responsive collapsed">
          <table  class="table table-bordered table-striped table-hover">
              ...
              <tr>
                  ...
                  <td>TPM</td>
                  <td class="counters" data-toggle="counter-up">144</td>
              </tr>
              <tr>
                  <td>2</td>
                  <td>Teknik Kendaraan Ringan Otomotif</td>
                  <td>TKRO</td>
                  <td class="counters" data-toggle="counter-up">72</td>
              </tr>
              <tr>
                  <td>3</td>
              ...
              <tr>
                  ...
                  <td>TKJ</td>
                  <td class="counters" data-toggle="counter-up">108</td>
              </tr>
              <tr>
                  <td>5</td>
                  <td>Multimedia</td>
              ...
              <tr>
                  <td>9</td>
                  <td>Agribisnis Pengolahan Hasil Perikanan</td>
                  <td>APHP</td>
                  <td class="counters" data-toggle="counter-up">72</td>
              </tr>
              <tr>
              ...
              <!--tr>
                  ...
                  <td class="counters" data-toggle="counter-up">144</td>
                  <td data-toggle="counter-up">1000</td>
              </tr-->
          </table>
        </div>
          ...
          <div class="card table-responsive collapsed">
                <div class="card-body">
                  <table id="listpendaftar" class="table-bordered table-striped table-hover responsive display nowrap">
                    <thead>
                    <tr>
                      <th data-priority="1">No. Pendaftar</th>
                      <th>NISN</th>
